...
関連：[[00_基礎理論/01_数学基礎/01_線形代数/05_圧縮率とRank]]、[[00_基礎理論/04_実験設計/10_SVD圧縮モデルの評価設計]]、[[00_基礎理論/02_ニューラルネットワーク基礎/12_PyTorch学習と評価の基礎]]
...
詳細：[[00_基礎理論/04_実験設計/10_SVD圧縮モデルの評価設計]]、[[00_基礎理論/02_ニューラルネットワーク基礎/12_PyTorch学習と評価の基礎]]
