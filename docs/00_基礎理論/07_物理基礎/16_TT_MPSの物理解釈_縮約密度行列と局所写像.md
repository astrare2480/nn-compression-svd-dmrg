...
「$r_1$ はサイト1の固有ベクトルを何本取った数なのか」を確認する。
...
ここまでではcanonical formの方向付けには進まず、本質を
...
直交中心で左右のブロック状態を取り直す意味と、QRとSchmidt分解の違いは [[42_MPS正準形と直交中心の物理的意味]] へ進む。行列化・QR・因子吸収の途中式と全要素例は [[00_基礎理論/01_数学基礎/02_テンソル代数/41_TT_MPSの直交中心の移動]] に置く。
